...
sudo nohup ./lite-linux-amd64 --config ./lite_config.json --test https://github.com/qjlxg/V2RayAggregator/raw/refs/heads/master/sub/sub_merge_yaml.yml > speedtest.log 2>&1 &
